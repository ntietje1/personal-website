    ...
    <div className="mb-8 flex pl-32">
      ...
      <div className="flex-grow relative">
        ...
        <div className="relative ml-6">
          ...
          <div className="pb-2 pt-2 pl-6 group">
            <a
              href={link}
              target="_blank"
              rel="noreferrer noopener"
              aria-label={`${title} at ${company} (opens in a new tab)`}
              className="relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50"
            >
